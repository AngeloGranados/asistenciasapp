...
import 'package:asistenciasapp/pages/qr_persona_page.dart';
          ...
          StreamBuilder(
            ...
            builder: (BuildContext context, AsyncSnapshot snapshot){
              ...
              if(!snapshot.hasData && snapshot.data == null){
                return Center(child: Text("No se encontraron datos para este participante"));
              }
              ...
              return Column(
                children: [
                  ...
                  ElevatedButton(onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => QrPersonaPage(idasistenciaReg: widget.personaReg.idasistencia,)));
                  }, child: Text("Generar QR", style: TextStyle(color: Colors.white)), style: ElevatedButton.styleFrom(backgroundColor: Colors.blue)),
                  SizedBox(height: 50),
                  Row(
